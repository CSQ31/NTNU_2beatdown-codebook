...
\section{Optimization tricks}
	...
	\subsection{Black magic}
		\begin{itemize}
			...
			\item \lstinline{#pragma GCC optimize("O3,unroll-loops")} same as above but safer
			\item \lstinline{#pragma GCC target("avx2,bmi,bmi2,lzcnt,popcnt")} optimizes bitwise operations
